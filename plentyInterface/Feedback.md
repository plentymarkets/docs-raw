...
<pre>public <strong>getFeedback</strong>(<a target="_blank" href="http://php.net/int">int</a> $feedbackId):<a href="feedback#feedback_models_feedback">Feedback</a>
</pre>
...
<pre>public <strong>listFeedbacks</strong>():<a href="miscellaneous#miscellaneous_support_collection">Collection</a>
</pre>

    
List feedbacks
    
<pre>public <strong>createFeedback</strong>(<a target="_blank" href="http://php.net/array">array</a> $data):<a href="feedback#feedback_models_feedback">Feedback</a>
</pre>
...
<table class="table table-bordered table-striped table-condensed table-hover">
    ...
    <tbody><tr>
            ...
            <td><a target="_blank" href="http://php.net/int">int</a></td>
            <td>averageCount</td>
            <td>The average count of the feedback</td>
        </tr><tr>
            <td><a href="miscellaneous#miscellaneous__"></a>
</td>
            <td>createdAt</td>
