...
The StockStorageLocationRepositoryContract is the interface for the stock storage location repository.
...
Lists storage locations of a warehouse. The ID of the warehouse must be specified.
