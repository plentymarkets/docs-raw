...
[[document_addressgroup_addressidvariable]]
==== AddressIDVariable
...
[[document_addressgroup_glnnumbervariable]]
==== GLNNumberVariable
...
[[document_groups_orderbankdatagroup]]
==== OrderBankDataGroup

The OrderBankData variables group
...
[[document_groups_taxrelevancegroup]]
==== TaxRelevanceGroup

The variable group for TAX relevance variables
...
a|`$itemsPerPage`
|link:http://php.net/int[int^]
a|The number of orders to be displayed per page.
The default number of orders per page is 50.
...
a|`$sortBy`
|link:http://php.net/string[string^]
a|This field is used for sorting. Default is 'id'.
Possible values are 'id', 'type', 'number', 'createdAt', 'displayDate', 'updatedAt'
...
a|`$type`
|link:http://php.net/string[string^]
a|The document type. Supported types are 'invoiceExternal', 'deliveryNote', 'poDeliveryNote',
'orderConfirmation', 'offer', 'dunningLetter', 'returnNote', 'successConfirmation',
'correction', 'creditNoteExternal', 'reorder', 'uploaded'.
...
public getDocumentComment($documentId):Plenty\Modules\Document\Models\DocumentComment
...
====== *Return type:*        xref:Document.adoc#document_models_documentcomment[`DocumentComment`]
...
public getTags($documentId):array
...
public setTags($documentId, $tags):array
...
|source
    |link:http://php.net/string[string^]
    a|The source where the document was generated. Possible sources are 'klarna',
'soap', 'admin', 'hitmeister', 'paypal' and 'rest'.
|displayDate
    |link:http://php.net/string[string^]
    a|The date displayed on the document
|status
    |link:http://php.net/string[string^]
    a|The generation status of the document
("pending", "faulty", "done" or "deleted")
...
|generationInformation
    |        xref:Document.adoc#document_models_documentgenerationinformation[`DocumentGenerationInformation`]
    a|
|===
...
[[document_models_documentgenerationinformation]]
==== DocumentGenerationInformation
...
[[document_models_documenttemplatexmlsetting]]
==== DocumentTemplateXMLSetting
