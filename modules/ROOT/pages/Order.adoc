...
|sortedOrderItems
    |
    a|The order items that are associated with the order sorted by relations.
|properties
    |
...
|orderCommentCount
    |link:http://php.net/int[int^]
    a|The number of order comments
|parentOrderId
    |link:http://php.net/int[int^]
    a|The ID of the parent order
|parentOrderType
    |link:http://php.net/int[int^]
    a|The type of the parent order
|===
...
|quantityTransactionsInBooked
    |link:http://php.net/float[float^]
    a|The summed up quantity of all transactions with direction 'in' and status 'regular' and is booked
|quantityTransactionsOutBooked
    |link:http://php.net/float[float^]
    a|The summed up quantity of all transactions with direction 'out' and status 'regular' and is booked
|priceTotalTransactionsInRegular
    |link:http://php.net/float[float^]
    a|The summed up price (in the currency of the order) of all transactions with direction 'in' and status 'regular'
|priceTotalTransactionsOutRegular
...
[[order_order_template]]
===  Template
[[order_template_orderfilterbuilderfactory]]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderwarehousefilterbuilder[`OrderWarehouseFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderstatusfilterbuilder[`OrderStatusFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_ordertypefilterbuilder[`OrderTypeFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderreferrerfilterbuilder[`OrderReferrerFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderpaymentmethodfilterbuilder[`OrderPaymentMethodFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderownerfilterbuilder[`OrderOwnerFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderclientfilterbuilder[`OrderClientFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderitemtypefilterbuilder[`OrderItemTypeFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderidfilterbuilder[`OrderIdFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_ordercreatedatfilterbuilder[`OrderCreatedAtFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderupdatedatfilterbuilder[`OrderUpdatedAtFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderpaidatfilterbuilder[`OrderPaidAtFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_ordercompletedatfilterbuilder[`OrderCompletedAtFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_orderreceiveddatefilterbuilder[`OrderReceivedDateFilterBuilder`]
...
====== *Return type:*        xref:Order.adoc#order_filters_ordershippingprofilefilterbuilder[`OrderShippingProfileFilterBuilder`]
...
[WARNING]
.Deprecated! [small]#(since 2025-07)#
====
...
public getLiveExchangeRates():Plenty\Modules\Order\Currency\Models\LiveExchangeRatesResult
...
====== *Return type:*        xref:Order.adoc#order_models_liveexchangeratesresult[`LiveExchangeRatesResult`]
...
[[order_models_liveexchangeratesresult]]
...
|lastUpdate
    |        xref:Miscellaneous.adoc#miscellaneous_carbon_carbon[`Carbon`]
    a|The last update of the exchange rates
|exchangeRates
    |link:http://php.net/array[array^]
...
public updateCountries($data):Illuminate\Support\Collection
...
|extraWeight
    |link:http://php.net/int[int^]
    a|The extra weight of the package in grams
|itemsWeight
    |link:http://php.net/int[int^]
    a|The items weight of the package in grams
|packageNumber
    |link:http://php.net/string[string^]
...
|individualWeight
    |link:http://php.net/int[int^]
    a|The individual weight of the shipping package type
|height
    |link:http://php.net/int[int^]
...
public restore($orderId, $data = [], $with = [], $lazyLoaded = false):Plenty\Modules\Order\Models\Order
...
public bookOrderItemTransactions($transactionIds, $warehouseId = null, $deliveryNoteNumber = null, $purchasePrices = []):Plenty\Modules\Order\Booking\Models\OrderBooking
...
[[order_template_filters]]
===  Filters
[[order_filters_orderclientfilterbuilder]]
==== OrderClientFilterBuilder
...
[[order_filters_ordercompletedatfilterbuilder]]
==== OrderCompletedAtFilterBuilder
...
[[order_filters_ordercreatedatfilterbuilder]]
==== OrderCreatedAtFilterBuilder
...
[[order_filters_orderexcludemainordersfilterbuilder]]
==== OrderExcludeMainOrdersFilterBuilder
...
[[order_filters_orderidfilterbuilder]]
==== OrderIdFilterBuilder
...
[[order_filters_orderitemtypefilterbuilder]]
==== OrderItemTypeFilterBuilder
...
[[order_filters_orderitemvariationidfilterbuilder]]
==== OrderItemVariationIdFilterBuilder
...
[[order_filters_orderownerfilterbuilder]]
==== OrderOwnerFilterBuilder
...
[[order_filters_orderpaidatfilterbuilder]]
==== OrderPaidAtFilterBuilder
...
[[order_filters_orderpaymentmethodfilterbuilder]]
==== OrderPaymentMethodFilterBuilder
...
[[order_filters_orderreceiveddatefilterbuilder]]
==== OrderReceivedDateFilterBuilder
...
[[order_filters_orderreferrerfilterbuilder]]
==== OrderReferrerFilterBuilder
...
[[order_filters_ordershippingprofilefilterbuilder]]
==== OrderShippingProfileFilterBuilder
...
[[order_filters_orderstatusfilterbuilder]]
==== OrderStatusFilterBuilder
...
[[order_filters_ordertypefilterbuilder]]
==== OrderTypeFilterBuilder
...
[[order_filters_orderupdatedatfilterbuilder]]
==== OrderUpdatedAtFilterBuilder
...
[[order_filters_orderwarehousefilterbuilder]]
==== OrderWarehouseFilterBuilder
...
`Plenty\Modules\Order\Offer\Settings\Models`
...
|
    |link:http://php.net/int[int^]
    a|defaultRepairReasonId
|
    |link:http://php.net/int[int^]
    a|defaultRepairStatusId
|===
...
|
    |link:http://php.net/int[int^]
    a|defaultReturnReasonId
|
    |link:http://php.net/int[int^]
    a|defaultReturnStatusId
|setShippingCostsToZero
    |link:http://php.net/bool[bool^]
    a|
|copyShippingCostsFromOriginOrder
...
[[order_creditnotereason]]
== CreditNoteReason

[[order_creditnotereason_contracts]]
===  Contracts
[[order_contracts_creditnotereasonrepositorycontract]]
...
====== *Return type:*        xref:Order.adoc#order_models_creditnotereason[`CreditNoteReason`]
...
a|`$id`
|link:http://php.net/int[int^]
a|The ID of the credit note reason.
|===
...
[[order_creditnotereason_models]]
===  Models
[[order_models_creditnotereason]]
==== CreditNoteReason
...
[[order_models_creditnotereasonname]]
...
public deleteMultiple($paths):bool
...
a|`$uniqueMainShippingProfiles`
|link:http://php.net/bool[bool^]
a|When true, only one result per main shipping profile is returned
|===
...
public manualRun($orderId, $skipNextRun = false, $data = []):Plenty\Modules\Order\Models\Order
...
a|`$skipNextRun`
|link:http://php.net/bool[bool^]
a|If true, the next run of this subscription will be skipped. Is only used when not given in $data.

a|`$data`
|link:http://php.net/array[array^]
a|Defines the order items that should be taken in the order. If empty, all items are taken.
|===
...
|warehouseLocation
    |        xref:Warehouse.adoc#warehouse_models_warehouselocation[`WarehouseLocation`]
    a|The related warehouse location
|===
