...
<1> [[__plenty\modules\order\coupon\campaign\code\models\couponcampaigncode]]

    link:order#order_models_couponcampaigncode[CouponCampaignCode^]
...
|[[__plenty\modules\order\coupon\campaign\models\couponcampaign]]
...
|[[__plenty\modules\authentication\models\user]]
...
|[[__]]
    ...
    |comments
    |The order comments.
|[[__plenty\modules\accounting\models\accountinglocation]]
...
|[[__plenty\modules\order\models\orderamount]]
...
|[[__plenty\modules\order\models\orderitemamount]]
...
|[[__plenty\modules\order\models\orderitemtype]]

    link:order#order_models_orderitemtype[OrderItemType^]

    |type
    |The order item type
|[[__plenty\modules\accounting\vat\models\vat]]
...
|[[__plenty\modules\order\models\orderitemtransactionsums]]
...
|[[__plenty\modules\order\models\orderitem]]
...
|link:http://php.net/string[string^]
    |lang
    |The ISO 639-1 language code for the name, e.g. "en" for English
|[[__plenty\modules\order\models\ordertype]]
...
<1> [[__plenty\modules\order\models\orderamount]]
...
<1> [[__plenty\modules\order\models\orderitem]]
...
<1> [[__plenty\modules\order\scheduler\models\orderscheduler]]
...
|===
|Type |Name |Description
|[[__plenty\modules\order\events\ordercreated]]
...
<1> [[__plenty\modules\order\coupon\campaign\models\couponcampaign]]
...
<1> [[__plenty\modules\order\coupon\code\contact\models\couponcodecontact]]

    link:order#order_models_couponcodecontact[CouponCodeContact^]
...
<1> [[__plenty\modules\order\coupon\code\validation\models\couponcodevalidation]]
...
<1> [[__plenty\modules\order\currency\models\currency]]
...
<1> [[__plenty\modules\order\currency\models\currencyexchangerate]]

    link:order#order_models_currencyexchangerate[CurrencyExchangeRate^]
...
|[[__plenty\modules\order\currency\models\currency]]
...
|link:http://php.net/array[array^]
    |coutries
    |
|[[__plenty\modules\order\payment\method\models\paymentmethodinformation]]
...
<1> [[__plenty\modules\order\pdf\events]]

    link:order#order_pdf_events[Events^]
...
|===
|Type |Name |Description
|[[__plenty\modules\order\pdf\models\orderpdfgeneration]]
...
<1> [[__plenty\modules\order\referrer\models\orderreferrer]]

    link:order#order_models_orderreferrer[OrderReferrer^]
...
|link:http://php.net/string[string^]
    |serialNumber
    |The serial number
|[[__plenty\modules\item\itemserialnumber\models\itemserialnumber]]
...
<1> [[__plenty\modules\order\shipping\parcelservice\models\parcelservicepreset]]

    link:order#order_models_parcelservicepreset[ParcelServicePreset^]
...
|===
|Type |Name |Description
|[[__plenty\modules\basket\models\basket]]
...
<1> [[__plenty\modules\order\shipping\events\aftershippingcostcalculated]]

    link:order#order_events_aftershippingcostcalculated[AfterShippingCostCalculated^]
...
<1> [[__plenty\modules\order\shipping\countries\models\country]]
...
<1> [[__plenty\modules\order\shipping\countries\models\countrystate]]
...
<1> [[__plenty\modules\order\shipping\exportdocuments\models\exportdocument]]

    link:order#order_models_exportdocument[ExportDocument^]
...
<1> [[__plenty\modules\order\shipping\information\models\shippinginformation]]

    link:order#order_models_shippinginformation[ShippingInformation^]
...
<1> [[__plenty\modules\order\shipping\package\models\ordershippingpackageitems]]

    link:order#order_models_ordershippingpackageitems[OrderShippingPackageItems^]
...
<1> [[__plenty\modules\order\shipping\package\models\ordershippingpackage]]
...
<1> [[__plenty\modules\order\shipping\packagetype\models\shippingpackagetype]]

    link:order#order_models_shippingpackagetype[ShippingPackageType^]
...
<1> [[__plenty\modules\order\shipping\pallet\models\ordershippingpallet]]

    link:order#order_models_ordershippingpallet[OrderShippingPallet^]
...
|link:http://php.net/string[string^]
    |splitDelimiter
    |
|[[__plenty\modules\order\shipping\serviceprovider\models\shippingserviceprovider]]
...
|[[__plenty\modules\order\shipping\parcelservice\models\parcelservice]]

    link:order#order_models_parcelservice[ParcelService^]

    |parcelService
    |The parcel service.
|[[__plenty\modules\order\shipping\parcelserviceregion\models\parcelserviceregion]]
...
<1> [[__plenty\modules\order\shipping\parcelserviceregion\models\parcelserviceregionname]]

    link:order#order_models_parcelserviceregionname[ParcelServiceRegionName^]
...
<1> [[__plenty\modules\order\shipping\parcelserviceregion\models\parcelserviceregion]]
...
<1> [[__plenty\modules\order\shipping\returns\models\registerreturnsresult]]

    link:order#order_models_registerreturnsresult[RegisterReturnsResult^]
...
<1> [[__plenty\modules\order\shipping\returns\models\orderreturns]]
...
<1> [[__plenty\modules\order\shipping\returns\models\returnsserviceprovider]]

    link:order#order_models_returnsserviceprovider[ReturnsServiceProvider^]
...
|===
|Type |Name |Description
|[[__plenty\modules\order\shipping\returns\models\successfullyregisteredorderreturns]]
...
|===
|Type |Name |Description
|[[__plenty\modules\order\shipping\returns\models\failedregisterorderreturns]]
...
|[[__plenty\modules\order\shipping\returns\models\orderreturns]]
...
<1> [[__plenty\modules\order\shipping\returns\services\entries\returnsserviceproviderentry]]

    link:order#order_entries_returnsserviceproviderentry[ReturnsServiceProviderEntry^]
...
<1> [[__plenty\modules\order\shipping\serviceprovider\services\entries\shippingserviceproviderentry]]

    link:order#order_entries_shippingserviceproviderentry[ShippingServiceProviderEntry^]
...
<1> [[__plenty\modules\order\shipping\serviceprovider\models\shippingserviceprovider]]
...
|===
|Type |Name |Description
|[[__plenty\modules\order\shipping\serviceprovider\models\successfullyregisteredshipment]]
...
|===
|Type |Name |Description
|[[__plenty\modules\order\shipping\serviceprovider\models\failedregistershipment]]
...
|===
|Type |Name |Description
|[[__plenty\modules\order\shipping\package\models\ordershippingpackage]]
...
<1> [[__plenty\modules\order\booking\models\orderbooking]]

    link:order#order_models_orderbooking[OrderBooking^]
...
<1> [[__plenty\modules\order\contactwish\models\contactwish]]

    link:order#order_models_contactwish[ContactWish^]
...
<1> [[__plenty\modules\order\date\models\orderdatetypename]]

    link:order#order_models_orderdatetypename[OrderDateTypeName^]
...
<1> [[__plenty\modules\order\date\models\orderdatetype]]
...
<1> [[__plenty\modules\order\date\models\orderdate]]

    link:order#order_models_orderdate[OrderDate^]
...
<1> [[__plenty\modules\order\date\models\orderitemdate]]

    link:order#order_models_orderitemdate[OrderItemDate^]
...
|[[__plenty\modules\order\date\models\orderdatetype]]
...
<1> [[__plenty\modules\order\property\models\orderitemproperty]]

    link:order#order_models_orderitemproperty[OrderItemProperty^]
...
<1> [[__plenty\modules\order\property\models\orderproperty]]

    link:order#order_models_orderproperty[OrderProperty^]
...
<1> [[__plenty\modules\order\property\models\orderpropertytype]]
...
|[[__plenty\modules\order\property\models\orderpropertytype]]
...
<1> [[__plenty\modules\order\relationreference\models\orderrelationreference]]

    link:order#order_models_orderrelationreference[OrderRelationReference^]
...
<1> [[__plenty\modules\order\returnreason\models\returnreason]]

    link:order#order_models_returnreason[ReturnReason^]
...
<1> [[__plenty\modules\order\status\models\orderstatus]]

    link:order#order_models_orderstatus[OrderStatus^]
...
<1> [[__plenty\modules\order\taricvatassignment\models\taricvatassignment]]

    link:order#order_models_taricvatassignment[TaricVatAssignment^]
...
|[[__plenty\modules\order\taricvatassignment\models\taricvatassignmentused]]
...
<1> [[__plenty\modules\order\transaction\models\orderitemtransaction]]

    link:order#order_models_orderitemtransaction[OrderItemTransaction^]
