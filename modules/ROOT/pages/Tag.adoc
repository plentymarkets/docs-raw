...
<1>         xref:Tag.adoc#tag_models_tagavailability[TagAvailability]
...
<1>         xref:Tag.adoc#tag_models_tagname[TagName]
...
<1>         xref:Tag.adoc#tag_models_tagrelationship[TagRelationship]
...
<1>         xref:Tag.adoc#tag_models_tag[Tag]
