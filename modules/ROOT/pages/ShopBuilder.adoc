...
===  Factories
[[shopbuilder_factories_widgetdatafactory]]
==== WidgetDataFactory
...
====== *Return type:*        xref:Shopbuilder.adoc#shopbuilder_factories_widgetdatafactory[`WidgetDataFactory`]
...
a|`$label`
|link:http://php.net/string[string^]
a|Label of the widget to be displayed in the shop builder
|===
...
a|`$maxPerPage`
|link:http://php.net/int[int^]
a|Maximum allowed amount of instances of the widget on a content
|===
...
[[shopbuilder_shopbuilder_widgets]]
===  Widgets
[[shopbuilder_widgets_basewidget]]
==== BaseWidget
...
a|`$widgetSettings`
|link:http://php.net/array[array^]
a|The settings provided by the widget.

a|`$children`
|link:http://php.net/array[array^]
a|The child widgets of the widget.
|===
...
[source%nowrap, php]
[#addentrywithcondition]
----

public addEntryWithCondition($value, $caption, $condition):Plenty\Modules\ContentBuilder\Factories\Settings\ValueListFactory
...
[[shopbuilder_widgets_helper]]
===  Helper
[[shopbuilder_helper_widgettypes]]
==== WidgetTypes
...
`Plenty\Modules\ShopBuilder\Widgets\Helper`
