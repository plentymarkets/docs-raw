...
<1> [[__plenty\modules\feedback\models\feedbackcomment]]

    link:feedback#feedback_models_feedbackcomment[FeedbackComment^]
...
<1> [[__plenty\modules\feedback\models\feedbackrating]]

    link:feedback#feedback_models_feedbackrating[FeedbackRating^]
...
|[[__plenty\modules\feedback\models\feedbacksourcerelation]]
