...
[source%nowrap, php]
[#getpresetsstartingwithmyviewkey]
----

public getPresetsStartingWithMyViewKey($myViewKeyStartsWith):array
...
[source%nowrap, php]
[#getdefaultpresetsstartingwithmyviewkey]
----

public getDefaultPresetsStartingWithMyViewKey($myViewKeyStartsWith):array
