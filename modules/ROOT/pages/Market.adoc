...
public setConfig($option, $value):Plenty\Modules\Market\Ebay\Api\Services\BaseRestService
...
====== *Return type:*        xref:Market.adoc#market_services_baserestservice[`BaseRestService`]
