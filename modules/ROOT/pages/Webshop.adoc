...
public getNavigationTree($type = &quot;all&quot;, $language = &quot;de&quot;, $clientId = null, $maxLevel = 6, $customerClassId, $resultFieldsTemplate = \Plenty\Modules\Webshop\ItemSearch\Helpers\ResultFieldTemplate::TEMPLATE_CATEGORY_TREE):array
...
[[webshop_contracts_countryrepositorycontract]]
...
[source%nowrap, php]
[#getwebstoreconfigurationbywebstoreid]
----
...
[source%nowrap, php]
[#addadditionalvariationproperties]
----
...
[source%nowrap, php]
[#getadditionalvariationproperties]
----
...
public getFormatter($currencyISO):void
...
[[webshop_helpers_propertyfileservice]]
==== PropertyFileService
...
|link:http://php.net/array[array^]
a|Available options
- `quantities` Quantities of the variations in the basket. This will be considered while calculating prices
...
a|`$propertyIds`
|link:http://php.net/array[array^]
a|The property(characteristic) ids to filter by.
|===
...
[source%nowrap, php]
[#withcanonicalvariationproperties]
----

public withCanonicalVariationProperties($itemCanonicalId):Plenty\Modules\Webshop\ItemSearch\Factories\VariationSearchFactory
...
- *variationId* Variation id to get. If not defined, plugin configuration will be considered
...
a|`$searches`
|
a|Associative array of search factories to execute.
Result of each search request will be mapped to the key defined in this array.
|===
...
[source%nowrap, php]
[#getresultswithdownloadlinkforproperties]
----
...
[[webshop_stock_contracts]]
===  Contracts
[[webshop_contracts_stockreservationrepositorycontract]]
...
[[webshop_storefront_models]]
===  Models
[[webshop_models_itemwishlist]]
==== ItemWishlist
...
|plentyId
    |link:http://php.net/int[int^]
    a|The actual PlentyID
|canDirectlyAddToCart
    |link:http://php.net/int[int^]
    a|Flag that determines if the item can be added to cart
|createdAt
    |
    a|The date when the item wishlist was created
|updatedAt
    |
    a|The date when the item wishlist was updated
|===
