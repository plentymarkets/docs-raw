...
<1> [[__plenty\modules\category\models\categorybranchmarketplace]]

    link:category#category_models_categorybranchmarketplace[CategoryBranchMarketplace^]
...
<1> [[__plenty\modules\category\models\categorybranch]]
...
<1> [[__plenty\repositories\contracts\paginationresponsecontract]]

    link:miscellaneous#miscellaneous_contracts_paginationresponsecontract[PaginationResponseContract^]
...
<1> [[__plenty\modules\category\models\categoryproperty]]

    link:category#category_models_categoryproperty[CategoryProperty^]
...
<1> [[__plenty\modules\category\models\category]]
...
<1> [[__plenty\modules\category\models\categorytemplate]]

    link:category#category_models_categorytemplate[CategoryTemplate^]
