...
<1> [[__plenty\modules\messenger\models\message]]

    link:messenger#messenger_models_message[Message^]
...
<1> [[__plenty\modules\messenger\models\attachment]]

    link:messenger#messenger_models_attachment[Attachment^]
...
|[[__plenty\modules\messenger\models\messagereferrer]]

    link:messenger#messenger_models_messagereferrer[MessageReferrer^]

    |referrer
    |The message referrer
|[[__plenty\modules\messenger\models\messagemetadata]]
...
|link:http://php.net/array[array^]
    |links
    |Array with links
|[[__plenty\modules\messenger\models\messagemetadatanotdone]]
