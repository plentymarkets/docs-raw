...
public searchReceiver($searchTerm):array
...
[source%nowrap, php]
[#updatesingleconversationfoldersrelations]
----

public updateSingleConversationFoldersRelations($conversationsUuid, $foldersUuidsToKeep):bool
...
{@link ConversationRelation::RELATION_TYPE_ORDER_ID})
|value
    |
