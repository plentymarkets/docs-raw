...
[source%nowrap, php]
[#getallattachmentsforbatchofmessages]
----

public getAllAttachmentsForBatchOfMessages($uuids):void
...
|whispered
    |link:http://php.net/bool[bool^]
    a|Whether the message is whispered
(not visible for the contact/order linked to the message) or not
|forwarded
    |link:http://php.net/bool[bool^]
    a|Whether the message is forwarded to another recipient or not
|tags
    |link:http://php.net/array[array^]
...
|inboxId
    |link:http://php.net/string[string^]
    a|The inboxId of the message/conversation
|categoryId
    |link:http://php.net/int[int^]
...
(example:{@link MessageTypesService::MESSAGE_TYPE_NEW_MESSAGE_FROM_CONTACT})
|marketplacesMetadata
    |        xref:Messenger.adoc#messenger_models_messagemarketplacesmetadatanew[`MessageMarketplacesMetaDataNew`]
    a|The marketplace metadata
|eventId
    |link:http://php.net/int[int^]
    a|The ID of the event that created the message
|===
...
|contacts
    |link:http://php.net/array[array^]
    a|A snapshot of the contacts from conversation->conversationRecipients
|orders
    |link:http://php.net/array[array^]
    a|A snapshot of the orders from conversation->conversationRecipients
|emails
    |link:http://php.net/array[array^]
    a|A snapshot of the emails from conversation->conversationRecipients
|===
...
[source%nowrap, php]
[#createdefaulttypesandstatuses]
----

public createDefaultTypesAndStatuses($id):bool
...
public updateRead($uuids, $userId, $read, $globalReadStatus = null):int
...
a|`$globalReadStatus`
|link:http://php.net/bool[bool^]
a|Is global read status active, when null it used the system settings
|===
...
public updateConversationsTypeAndStatus($conversationsUuids, $typeId, $statusId, $categoryId = null):bool
...
a|`$categoryId`
|link:http://php.net/int[int^]
a|Category ID of conversation. If null is passed, the conversation category will not be changed.
|===
...
[source%nowrap, php]
[#getamazonallowedactions]
----

public getAmazonAllowedActions($orderIds):array
...
public getMaxPosition($typeId):void
...
public getMaxPosition($categoryId):void
...
public getConversationUUIDs():void
...
[[messenger_events_donestatuschangeconversationevent]]
==== DoneStatusChangeConversationEvent
...
[[messenger_events_markasreadconversationevent]]
...
|conversationRecipients
    |link:http://php.net/array[array^]
    a|The recipients of new Messages
|tagIds
    |link:http://php.net/array[array^]
    a|Array of tag IDs
|isClosed
...
|referrerId
    ...
    a|The referrer ID of the entity
|clientId
    |link:http://php.net/int[int^]
    a|The client ID of the entity
|===
...
[[messenger_amazon_models]]
===  Models
[[messenger_models_marketplacesmetadataamazonproperties]]
==== MarketplacesMetaDataAmazonProperties
...
`Plenty\Modules\Messenger\Settings\Inboxes\Marketplaces\Amazon\Models`
...
|messagingAction
    |link:http://php.net/string[string^]
    a|The action to be performed in the messaging API
|===
...
`Plenty\Modules\Messenger\Settings\Inboxes\Marketplaces\Ebay\Models`
...
===  Models
[[messenger_models_messagemarketplacesmetadatanew]]
==== MessageMarketplacesMetaDataNew
...
`Plenty\Modules\Messenger\Settings\Inboxes\Marketplaces\Models`
...
|ebayProperties
    ...
    a|Ebay properties
|amazonProperties
    |        xref:Messenger.adoc#messenger_models_marketplacesmetadataamazonproperties[`MarketplacesMetaDataAmazonProperties`]
    a|Amazon properties
|===
