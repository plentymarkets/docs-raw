...
[source%nowrap, php]
[#registerruleforplugin]
----

public registerRuleForPlugin($ruleClass, $pluginName):void
...
|isDocumentBuilderActive
    |link:http://php.net/bool[bool^]
    a|Flag that indicates if payment method is checked for document builder
|===
