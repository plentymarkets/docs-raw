...
<1> [[__plenty\modules\contentcache\contentcachesettings\contentcachesettings]]

    link:contentcache#contentcache_contentcachesettings_contentcachesettings[ContentCacheSettings^]
