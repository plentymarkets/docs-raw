...
|platform
    |link:http://php.net/array[array^]
    a|Details about what platform does the plugin support.
...
public loadPatterns($url, $headers = []):bool
...
a|`$pluginSetId`
|link:http://php.net/int[int^]
a|The id of the PluginSet for the PluginSetEntry which should be retrieved.

a|`$pluginId`
|link:http://php.net/int[int^]
a|The id of the Plugin for the PluginSetEntry which should be retrieved.
|===
