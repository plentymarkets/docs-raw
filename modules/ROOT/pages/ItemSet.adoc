...
<1> [[__plenty\modules\itemset\models\itemsetcomponent]]

    link:itemset#itemset_models_itemsetcomponent[ItemSetComponent^]
...
<1> [[__plenty\modules\itemset\models\itemsetconfig]]
...
<1> [[__plenty\modules\itemset\models\itemset]]

    link:itemset#itemset_models_itemset[ItemSet^]
