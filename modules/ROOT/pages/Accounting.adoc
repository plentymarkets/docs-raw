...
<1>         xref:Accounting.adoc#accounting_models_accountinglocation[AccountingLocation]
...
<1>         xref:Accounting.adoc#accounting_models_accountinglocationsettings[AccountingLocationSettings]
...
<1>         xref:Accounting.adoc#accounting_models_debtoraccountconfiguration[DebtorAccountConfiguration]
...
<1>         xref:Accounting.adoc#accounting_models_postingkeyconfiguration[PostingKeyConfiguration]
...
<1>         xref:Accounting.adoc#accounting_models_revenueaccountlocationconfiguration[RevenueAccountLocationConfiguration]
...
<1>         xref:Accounting.adoc#accounting_models_revenueaccountcountryconfiguration[RevenueAccountCountryConfiguration]
