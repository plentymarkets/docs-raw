...
<1> [[__plenty\modules\bi\keyfigure\models\keyfigureresultsearchresponse]]

    link:bi#bi_models_keyfigureresultsearchresponse[KeyFigureResultSearchResponse^]
...
|[[__plenty\modules\bi\keyfigure\models\keyfiguresearchrequests]]
...
<1> [[__plenty\modules\bi\rawdata\models\rawdatasearchresult]]

    link:bi#bi_models_rawdatasearchresult[RawDataSearchResult^]
...
<1> [[__plenty\modules\bi\rawdata\models\rawdataconfigs]]

    link:bi#bi_models_rawdataconfigs[RawDataConfigs^]
