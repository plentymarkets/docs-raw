...
|fullCount
    |link:http://php.net/int[int^]
    a|Number of total results from 'count(*) OVER() AS "fullCount"' when using pagination
|===
...
|aggregateDimensions
    |link:http://php.net/bool[bool^]
    a|Returns results for all dimensions
|aggregateFunction
    |link:http://php.net/string[string^]
...
|plenty_id
    |link:http://php.net/int[int^]
    a|The numeric plenty id
|plenty_id_hash
    |link:http://php.net/string[string^]
    a|The plenty id hash
|cloud_id
    |link:http://php.net/int[int^]
    a|The numeric cloud id
|ac_id
    |link:http://php.net/int[int^]
    a|
|sys_domain
...
|plenty_id_string
    |link:http://php.net/string[string^]
    a|The string version of the plenty id
|===
