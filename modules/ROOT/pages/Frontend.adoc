...
public setCustomerInvoiceAddressId($invoiceAddressId, $skipBasketCalculation = false):void
...
public setCustomerShippingAddressId($shippingAddressId, $skipBasketCalculation = false):void
...
[source%nowrap, php]
[#isskipbasketcalculation]
----

public isSkipBasketCalculation():bool
...
public setLanguage($newLanguage, $fireEvents = true, $isDetectedByBrowserLanguage = false):void
