...
public setParents($catalogIds, $parentId):void
...
|with
    |link:http://php.net/array[array^]
    a|Contains the data attached to the catalog
|showMandatoryFields
    |link:http://php.net/bool[bool^]
...
public __construct($exportKey, $key, $label, $catalogMappingValueProvider, $catalogTemplateFieldContainer, $isRequired = false, $isLocked = false, $isArray = false, $meta = [], $defaultSources = [], $templates = [], $description = null):void
...
[source%nowrap, php]
[#applycustomchannelmapkey]
----

public applyCustomChannelMapKey($key):void
...
public __construct($exportKey, $key, $label, $catalogMappingValueProvider, $isRequired = false, $isLocked = false, $isArray = false, $meta = [], $defaultSources = [], $templates = [], $description = null):void
...
public __construct($exportKey, $key, $label, $isRequired = false, $isLocked = false, $isArray = false, $meta = [], $defaultSources = [], $templates = [], $description = null):void
...
[source%nowrap, php]
[#getforcedfieldsforchannel]
----

public getForcedFieldsForChannel():Plenty\Modules\Catalog\Containers\TemplateGroupContainer
...
public setMapFieldKeys($mapFieldKeys):void
...
[source%nowrap, php]
[#setforcedfieldsforchannel]
----

public setForcedFieldsForChannel($templateGroupContainer):void
...
[[catalog_defaults_csvresultconverterarrayasjson]]
...
[source%nowrap, php]
[#getjsonencodeunicodecharacters]
----

public getJSONEncodeUnicodeCharacters():bool
