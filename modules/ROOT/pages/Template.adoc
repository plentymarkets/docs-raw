...
<1> [[__plenty\modules\template\design\config\models\designconfig]]

    link:template#template_models_designconfig[DesignConfig^]
...
|===
|Type |Name |Description
|[[__plenty\modules\template\design\config\models\design]]
...
<1> [[__plenty\modules\template\design\config\models\design]]
