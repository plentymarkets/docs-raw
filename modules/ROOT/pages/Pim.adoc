...
public hasNotCategoryIds($categoryIds, $depth = self::DEPTH_ANY):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotClientIds($clientIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasPriceIds($priceIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotPriceIds($priceIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasAnySupplier($tagIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasAllSuppliers($supplierIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotSupplierIds($supplierIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotTagIds($tagIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotReferrerIds($ids):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotIds($ids):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotItemIds($itemIds):Plenty\Modules\Pim\SearchService\Filter
...
public hasNotBundleType($bundleType):Plenty\Modules\Pim\SearchService\Filter
