...
|createdAt
    |        xref:Miscellaneous.adoc#miscellaneous_carbon_carbon[`Carbon`]
    a|The creation date of the relation selection value
|updatedAt
    |        xref:Miscellaneous.adoc#miscellaneous_carbon_carbon[`Carbon`]
    a|The last update date of the relation selection value
|===
...
|createdAt
    |        xref:Miscellaneous.adoc#miscellaneous_carbon_carbon[`Carbon`]
    a|The creation date of the relation value
|updatedAt
    |        xref:Miscellaneous.adoc#miscellaneous_carbon_carbon[`Carbon`]
    a|The last update date of the relation value
|===
...
|updatedAt
    |        xref:Miscellaneous.adoc#miscellaneous_carbon_carbon[`Carbon`]
    a|The time the linked image was last updated
|===
