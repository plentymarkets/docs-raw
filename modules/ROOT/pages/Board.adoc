...
<1>         xref:board.adoc#board_models_boardcolumn[BoardColumn]
...
<1>         xref:board.adoc#board_models_board[Board]
...
<1>         xref:board.adoc#board_models_boardtaskreference[BoardTaskReference]
...
<1>         xref:board.adoc#board_models_boardtask[BoardTask]
