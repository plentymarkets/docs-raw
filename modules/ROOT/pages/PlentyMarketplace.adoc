...
<1> [[__plenty\modules\plentymarketplace\models\subscriptionorderinformation]]

    link:plentymarketplace#plentymarketplace_models_subscriptionorderinformation[SubscriptionOrderInformation^]
