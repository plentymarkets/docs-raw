...
|amazonProductType
    |link:http://php.net/int[int^]
    a|The Amazon product type of the item (deprecated as of June 2025). List of IDs:
https://www.plentymarkets.co.uk/manual/data-exchange/data-formats/item/
|amazonProductType2
    |link:http://php.net/string[string^]
    a|The new Amazon product type of the item.
|amazonFedas
    |link:http://php.net/string[string^]
...
|legalName
    |link:http://php.net/string[string^]
    a|The legal name of the manufacturer
|externalName
    |link:http://php.net/string[string^]
...
|contactUrl
    |link:http://php.net/string[string^]
    a|The Contact URL of the manufacturer's website
|street
    |link:http://php.net/string[string^]
...
|responsibleName
    |link:http://php.net/string[string^]
    a|The name of the EU-Responsible person
|responsibleStreet
    |link:http://php.net/string[string^]
    a|The street of the EU-Responsible person
|responsibleHouseNo
    |link:http://php.net/string[string^]
    a|The house number of the EU-Responsible person
|responsiblePostCode
    |link:http://php.net/string[string^]
    a|The postal code of the EU-Responsible person
|responsibleTown
    |link:http://php.net/string[string^]
    a|The town of the EU-Responsible person
|responsibleCountry
    |link:http://php.net/int[int^]
    a|The country of the EU-Responsible person
|responsibleEmail
    |link:http://php.net/string[string^]
    a|The email address of the EU-Responsible person
|responsibleContactUrl
    |link:http://php.net/string[string^]
    a|The contact form the EU-Responsible person
|responsiblePhoneNo
    |link:http://php.net/string[string^]
    a|The phone number of the EU-Responsible person
|responsibleCountryIso
    |link:http://php.net/string[string^]
    a|The ISO code of the country of the EU-Responsible person
|responsibleCountryName
    |link:http://php.net/string[string^]
    a|The name of the country of the EU-Responsible person
|commissions
    |link:http://php.net/array[array^]
    a|
|externals
...
[WARNING]
.Deprecated! [small]#(since 2023-09-01)#
====
...
|campaignId
    |link:http://php.net/int[int^]
    a|The id of the campaign for the variation
|categoryVariationId
    |link:http://php.net/int[int^]
...
|title
    |link:http://php.net/string[string^]
    a|The html title for webshop of the item. By default, this title is displayed in the online store html. Character limit: max. 240 characters.
|name2
    |link:http://php.net/string[string^]
...
a|`$variationId`
|link:http://php.net/int[int^]
a|The unique ID of the variation which belongs to the market ident number ID
|===
