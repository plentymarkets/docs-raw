...
public addAmazonFlatFile($flatFile):Plenty\Modules\Item\Catalog\ExportTypes\Variation\Filters\Builders\Item
...
public addItemId($itemId):Plenty\Modules\Item\Catalog\ExportTypes\Variation\Filters\Builders\Item
...
public addTagId($tagId):Plenty\Modules\Item\Catalog\ExportTypes\Variation\Filters\Builders\Tag
...
public addAvailability($availability):Plenty\Modules\Item\Catalog\ExportTypes\Variation\Filters\Builders\VariationBase
...
public addClient($client):Plenty\Modules\Item\Catalog\ExportTypes\Variation\Filters\Builders\VariationClient
...
public addMarketId($marketId):Plenty\Modules\Item\Catalog\ExportTypes\Variation\Filters\Builders\VariationMarket
...
public addPropertySelectionId($propertySelectionId):Plenty\Modules\Item\Catalog\ExportTypes\Variation\Filters\Builders\VariationProperty
