...
===  Contracts
[[flow_contracts_adaptationdefinitioncontract]]
==== AdaptationDefinitionContract
...
`Plenty\Modules\Flow\Adaptations\Definitions\Contracts`
...
public performTask($inputs, $replaceOption, $configFields = []):array
...
public shouldBeRegistered():bool
...
public searchCriteria($field = []):string
...
public searchCriteriaValue($value, $operator = &quot;&quot;):void
...
public getParentPathIcon():string
...
public setFlowName($flowName):void
...
[source%nowrap, php]
[#addprintconfigurationsfield]
----

public addPrintConfigurationsField($printConfigurationsField, $key = &quot;key&quot;):void
...
|===
|Name |Type |Description
a|`$printConfigurationsField`
|        xref:Flow.adoc#flow_configform_printconfigurationsfield[`PrintConfigurationsField`]
a|
...
public addEditorField($editorField, $key = &quot;key&quot;):void
...
|Name |Type |Description
a|`$editorField`
|        xref:Flow.adoc#flow_editors_editorbasefield[`EditorBaseField`]
a|
...
|conditionKeys
    |link:http://php.net/string[string^]
    a|The condition keys included in the condition
|effectedFields
    |link:http://php.net/array[array^]
    a|Fields that will be effected on change
|helperText
    |link:http://php.net/array[array^]
    a|The helper text of the field
|setupPath
    |link:http://php.net/string[string^]
    a|The path to a setup view
|===
...
[[flow_configform_printconfigurationsfield]]
==== PrintConfigurationsField
...
|tooltip
    |link:http://php.net/string[string^]
    a|Optional tooltip for this box value
|===
...
[[flow_configform_editors]]
===  Editors
[[flow_editors_editorbasefield]]
==== EditorBaseField
...
`Plenty\Modules\Flow\DataModels\ConfigForm\Editors`
...
[[flow_editors_froalaeditorfield]]
==== FroalaEditorField
