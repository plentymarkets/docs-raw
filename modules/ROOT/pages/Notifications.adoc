...
<1> [[__plenty\repositories\models\unspecifiedlengthpaginationresponse]]

    link:miscellaneous#miscellaneous_models_unspecifiedlengthpaginationresponse[UnspecifiedLengthPaginationResponse^]
